export const LEAGUE_ABI = [
    ...
    "outputs": [
      {
        "name": "cycle",
        "type": "tuple",
        "internalType": "struct ILeague.Cycle",
        "components": [
          {
            "name": "startTime",
            "type": "uint256",
          ...
          },
          {
            "name": "status",
            "type": "uint8",
            "internalType": "enum ILeague.CycleStatus"
          }
        ]
      }
    ],
    ...
    "outputs": [
      {
        "name": "stats",
        "type": "tuple",
        "internalType": "struct ILeague.PlayerStats",
        "components": [
          {
            "name": "wins",
            "type": "uint256",
  ...
  {
    "type": "error",
    "name": "CycleAlreadyFinalized",
    "inputs": []
  },
  {
    "type": "error",
    "name": "CycleNotFinalized",
    "inputs": []
  },
  {
    "type": "error",
