...
injectConfigIntoEnv()
    ↓
process.env.NEXT_PUBLIC_GAMESCORE_ADDRESS = "0xscoreboard..."
    ↓
App renders
    ↓
...
# 2. Deploy GameScore manually
# 3. Copy address: 0xabc...
# 4. Set env var: NEXT_PUBLIC_GAMESCORE_ADDRESS=0xabc...
...
export NEXT_PUBLIC_GAMESCORE_ADDRESS=0xyourExisting...
